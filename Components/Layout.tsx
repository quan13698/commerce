  ...
  return (
    <>
      ...
      <div className='flex min-h-screen flex-col justify-between'>
          <header className='content-center w-full py-2'>
            <div className='mx-64 px-6  lg:max-max-3xl:mx-0 lg:max-max-3xl:w-full xl:max-max-4xl:mx-4 xll:max-max-5xl:mx-32 xlll:max-max-6xl:mx-44'>
              <div className='justify-between flex '> 
                  <div className='flex h-10 w-2/3'>
                    <div className='w-14 mr-10'>
                      <img src="https://salt.tikicdn.com/ts/upload/e4/49/6c/270be9859abd5f5ec5071da65fab0a94.png" className='h-10' alt="" />
                    </div>
                    <div className=' flex border border-opacity-30 border-gray-500 rounded-lg w-full'>
                      <img src="https://salt.tikicdn.com/ts/upload/33/d0/37/6fef2e788f00a16dc7d5a1dfc5d0e97a.png" className='p-2 content-center '/>
                      <input type="text" placeholder="Bạn tìm gì hôm nay" className='w-10/12 outline-none'/>
                      <button className='w-2/12 border-l-gray-500 border border-opacity-20 text-blue-500 text-sm rounded-r-lg hover:bg-blue-200'>
                        <div className=''>Tìm kiếm</div>  
                      </button>  
                    </div>
                  </div>
                  <div className='flex lg:max-max-3xl:flex-none lg:max-max-3xl:ml-10 '>
                        <div className='flex hover:bg-blue-100 items-center px-3 rounded-lg '>
                          ...
                          <a className='text-blue-500 mx-1 font-bold'>Trang chủ</a>
                        </div>
                        <div className='flex hover:bg-gray-200 items-center px-3 rounded-lg'>
                          ...
                          <a href="#" className='opacity-50 mx-1'>Astra</a>
                        </div>
                        <div className='flex hover:bg-gray-200 items-center px-3 rounded-lg'>
                          ...
                          <a href="#" className='opacity-50 mx-1'>Tài khoản</a>
                        </div>
                        <div className='relative p-2 hover:bg-blue-200 rounded-md'>
                          <span className="absolute top-0 right-0 rounded-lg bg-red-500 w-3 text-white h-4">
              ...
              <div className='justify-between flex h-8 '>
                <ul className='flex px-20 items-center lg:max-max-3xl:flex-none lg:max-max-3xl:px-0 xl:max-max-4xl:flex-none xl:max-max-4xl:px-0 xl:max-max-4xl:pl-20 xll:max-max-5xl:flex-none xll:max-max-5xl:px-0 xll:max-max-5xl:pl-20 xlll:max-max-6xl:flex-none xlll:max-max-6xl:px-0 xlll:max-max-6xl:pl-20 4xl:max-max-7xl:flex-none'>
                  <li className='mx-1 text-l lg:max-max-3xl:text-sm opacity-60'>trái cây</li>
                  <li className='mx-1 text-l lg:max-max-3xl:text-sm opacity-60'>thịt, trứng</li>
                  <li className='mx-1 text-l lg:max-max-3xl:text-sm opacity-60'>rau củ quả</li>
                  <li className='mx-1 text-l lg:max-max-3xl:text-sm opacity-60'>sữa, bơ, phô mai</li>
                  <li className='mx-1 text-l lg:max-max-3xl:text-sm opacity-60'>hải sản</li>
                  <li className='mx-1 text-l lg:max-max-3xl:text-sm opacity-60'>gạo, mì ăn liền</li>
                  <li className='mx-1 text-l lg:max-max-3xl:text-sm opacity-60'>đồ uống, bia rượu</li>
                  <li className='mx-1 text-l lg:max-max-3xl:text-sm opacity-60'>bánh kẹo</li>
                </ul>
                <div className='flex ml-20 text-m lg:max-max-3xl:text-sm items-center lg:max-max-3xl:flex-none lg:max-max-3xl:ml-0 xl:max-max-4xl:flex-none  xl:max-max-4xl:ml-0 xll:max-max-5xl:flex-none 4xl:max-max-7xl:flex-none'>
                  ...
                  <div className='ml-1 font-bold underline opacity-60'>Q. Hoàn Kiếm, P. Hàng Trống, Hà Nội</div>
                </div>
              </div>
            </div>          
          </header>
          <div className='h-10 px-4 py-2 bg-yellow-200'>
            <a href="" className='flex text-sm items-center text-center justify-center'>
              <img src="https://salt.tikicdn.com/ts/upload/5e/ec/fb/150f3c633781ed1da9921e45db90c62d.png" alt="" className='h-3 mr-1'/>
              <div>
                <strong>mọi đơn từ 149K. </strong>
                Áp dụng cho cả TikiNOW 2h
              </div>
              <div className=''>
                <img src="https://salt.tikicdn.com/ts/upload/51/20/3f/1bb77cdb828972a5284a06dac79c0afc.png" alt="" className='h-3 ml-1'/>
              </div>
            </a>
          </div>
          {/* main -- content */}
          <main className=''>
            {/* menu - bar  */}
            <div className=' flex mx-64 px-6 py-4 justify-between lg:max-max-3xl:mx-4 xl:max-max-4xl:mx-10 xll:max-max-5xl:mx-32 xlll:max-max-6xl:mx-44'>
              {/* menu */}
              <div className='w-60 max-h-full '>
                ...
                <div className='px-2'>
                  ...
                  <a className='flex hover:bg-gray-300 items-center py-2 px-4 rounded-lg w-52' href="https://tiki.vn/khuyen-mai/sieu-hoi-astra?src=top_desktop_icon" title="3.3 Sale Freeship">
                    <div className='mr-2'>
                            <picture>
                  ...
                  <a className='flex w-52  hover:bg-gray-300 items-center py-2 px-4 rounded-lg' href="https://tiki.vn/khuyen-mai/sieu-hoi-astra?src=top_desktop_icon" title="Giá Tốt Mỗi Ngày">
                    <div className='mr-2'>
                            <picture>
                  ...
                  <a className='flex w-52  hover:bg-gray-300 items-center py-2 px-4 rounded-lg' href="https://tiki.vn/khuyen-mai/sieu-hoi-astra?src=top_desktop_icon" title="Mã giảm giá">
                    <div className='mr-2'>
                            <picture>
                  ...
                  <a className='flex w-52  hover:bg-gray-300 items-center py-2 px-4 rounded-lg' href="https://tiki.vn/khuyen-mai/sieu-hoi-astra?src=top_desktop_icon" title="Ưu đãi Affiliate">
                    <div className='mr-2'>
                            <picture>
                  ...
                  <a className='flex w-52  hover:bg-gray-300 items-center py-2 px-4 rounded-lg' href="https://tiki.vn/khuyen-mai/sieu-hoi-astra?src=top_desktop_icon" title="Đóng tiền, nạp thẻ">
                    <div className='mr-2'>
                            <picture>
                  ...
                  <a className='flex w-52  hover:bg-gray-300 items-center py-2 px-4 rounded-lg' href="https://tiki.vn/khuyen-mai/sieu-hoi-astra?src=top_desktop_icon" title="Mua trước trả sau">
                    <div className='mr-2'>
                            <picture>
                  ...
                  <a className='flex w-52  hover:bg-gray-300 items-center py-2 px-4 rounded-lg' href="https://tiki.vn/khuyen-mai/sieu-hoi-astra?src=top_desktop_icon" title="Ưu đãi thẻ, ví">
                    <div className='mr-2'>
                            <picture>
                  ...
                  <a className='flex w-52  hover:bg-gray-300 items-center py-2 px-4 rounded-lg' href="https://tiki.vn/khuyen-mai/sieu-hoi-astra?src=top_desktop_icon" title="Bảo hiểm Tiki360">
                    <div className='mr-2'>
                            <picture>
                  ...
                  <a className='flex w-52  hover:bg-gray-300 items-center py-2 px-4 rounded-lg' href="https://tiki.vn/khuyen-mai/sieu-hoi-astra?src=top_desktop_icon" title="Tiki Exchange">
                    <div className='mr-2'>
                            <picture>
                ...
                <div className='px-2'>
                  ...
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/do-choi-me-be/c2549" title="Đồ Chơi - Mẹ & Bé">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Đồ Chơi - Mẹ & Bé" className="text-m ">Đồ Chơi - Mẹ & Bé</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/tikingon/ngon/c44792" title="NGON">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="NGON" className="text-m">NGON</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/dien-thoai-may-tinh-bang/c1789" title="Điện Thoại - Máy Tính Bảng">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Điện Thoại - Máy Tính Bảng" className="text-m">Điện Thoại - Máy Tính Bảng</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/lam-dep-suc-khoe/c1520" title="Làm Đẹp - Sức Khỏe">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Làm Đẹp - Sức Khỏe" className="text-m">Làm Đẹp - Sức Khỏe</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/dien-gia-dung/c1882" title="Điện Gia Dụng">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Điện Gia Dụng" className="text-m">Điện Gia Dụng</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/thoi-trang-nu/c931" title="Thời trang nữ">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Thời trang nữ" className="text-m">Thời trang nữ</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/thoi-trang-nam/c915" title="Thời trang nam">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Thời trang nam" className="text-m">Thời trang nam</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/giay-dep-nu/c1703" title="Giày - Dép nữ">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Giày - Dép nữ" className="text-m">Giày - Dép nữ</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/tui-vi-nu/c976" title="Túi thời trang nữ">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Túi thời trang nữ" className="text-m">Túi thời trang nữ</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/giay-dep-nam/c1686" title="Giày - Dép nam">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Giày - Dép nam" className="text-m">Giày - Dép nam</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/tui-thoi-trang-nam/c27616" title="Túi thời trang nam">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Túi thời trang nam" className="text-m">Túi thời trang nam</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/balo-va-vali/c6000" title="Balo và Vali">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Balo và Vali" className="text-m">Balo và Vali</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/phu-kien-thoi-trang/c27498" title="Phụ kiện thời trang">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Phụ kiện thời trang" className="text-m">Phụ kiện thời trang</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/dong-ho-va-trang-suc/c8371" title="Đồng hồ và Trang sức">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Đồng hồ và Trang sức" className="text-m">Đồng hồ và Trang sức</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/laptop-may-vi-tinh-linh-kien/c1846" title="Laptop - Máy Vi Tính - Linh kiện">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Laptop - Máy Vi Tính - Linh kiện" className="text-m">Laptop - Máy Vi Tính - Linh kiện</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/nha-cua-doi-song/c1883" title="Nhà Cửa - Đời Sống">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Nhà Cửa - Đời Sống" className="text-m">Nhà Cửa - Đời Sống</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/cross-border-hang-quoc-te/c17166" title="Cross Border - Hàng Quốc Tế">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Cross Border - Hàng Quốc Tế" className="text-m">Cross Border - Hàng Quốc Tế</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/bach-hoa-online/c4384" title="Bách Hóa Online">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Bách Hóa Online" className="text-m">Bách Hóa Online</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/thiet-bi-kts-phu-kien-so/c1815" title="Thiết Bị Số - Phụ Kiện Số">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Thiết Bị Số - Phụ Kiện Số" className="text-m">Thiết Bị Số - Phụ Kiện Số</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/voucher-dich-vu/c11312" title="Voucher - Dịch vụ">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Voucher - Dịch vụ" className="text-m">Voucher - Dịch vụ</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/o-to-xe-may-xe-dap/c8594" title="Ô Tô - Xe Máy - Xe Đạp">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Ô Tô - Xe Máy - Xe Đạp" className="text-m">Ô Tô - Xe Máy - Xe Đạp</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/nha-sach-tiki/c8322" title="Nhà Sách Tiki">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Nhà Sách Tiki" className="text-m">Nhà Sách Tiki</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/dien-tu-dien-lanh/c4221" title="Điện Tử - Điện Lạnh">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Điện Tử - Điện Lạnh" className="text-m">Điện Tử - Điện Lạnh</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/the-thao-da-ngoai/c1975" title="Thể Thao - Dã Ngoại">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Thể Thao - Dã Ngoại" className="text-m">Thể Thao - Dã Ngoại</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/may-anh/c1801" title="Máy Ảnh - Máy Quay Phim">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Máy Ảnh - Máy Quay Phim" className="text-m">Máy Ảnh - Máy Quay Phim</div>
                  </a>
                  <a className='flex w-52 hover:bg-gray-300 rounded-lg items-center py-2 px-4' href="https://tiki.vn/san-pham-tai-chinh-bao-hiem/c54042" title="Sản phẩm Tài chính - Bảo hiểm">
                    <div className='mr-2'>
                            <picture>
                    ...
                    <div title="Sản phẩm Tài chính - Bảo hiểm" className="text-m ">Sản phẩm Tài chính - Bảo hiểm</div>
                  </a>
                </div>

                {/* bán hàng cùng tiki  */}
                <div className='px-2 mt-5'>
                  <a className='flex w-52 items-center py-2 px-4 hover:bg-gray-300 rounded-lg' href="https://tiki.vn/khuyen-mai/ban-hang-cung-tiki" title="Bán hàng cùng Tiki">
                      <div>
                              <picture>
                                ...
                                <img className='mr-1' src="https://salt.tikicdn.com/ts/upload/08/2f/14/fd9d34a8f9c4a76902649d04ccd9bbc5.png" width="32" height="32" alt="3.3 Sale Freeship" srcSet="https://salt.tikicdn.com/cache/100x100/ts/upload/08/2f/14/fd9d34a8f9c4a76902649d04ccd9bbc5.png 1x, https://salt.tikicdn.com/cache/100x100/ts/upload/08/2f/14/fd9d34a8f9c4a76902649d04ccd9bbc5.png 2x"/>
                              </picture>
                      </div>
              ...
              <div className='w-full'>
                ...
                <div className='flex justify-between'>
                  <div className='rounded-lg'>
                    <img src="https://salt.tikicdn.com/ts/tikimsp/d1/51/be/60434c32b1dcd945dc0710272cac651c.png" className='h-69 lg:max-max-3xl:h-60 xll:max-max-5xl:h-64 rounded-xl' alt="" />
                  </div>

                  <div className=''>
                    <img src="https://salt.tikicdn.com/ts/tikimsp/6a/45/5a/60d59dc91d36b4231578368201c09fc9.png" className='h-69 lg:max-max-3xl:h-60 xll:max-max-5xl:h-64 rounded-xl' alt="" />
                  </div>
                </div>

                {/* Real brand */}
                <div className='w-full px-4 py-3 mt-4 bg-gradient-to-b rounded-md from-green-100'>
                  ...
                  <div className='flex mt-4 bg-opacity-95'>
                    <div className='w-1/6 mx-1'>
                      <img src="https://salt.tikicdn.com/ts/tikimsp/54/47/51/634324b85e8f67bb807c3655de1da56f.png" className='hover:opacity-90' alt="" />
                    </div>
                    <div className='w-1/6 mx-1'>
                      <img src="https://salt.tikicdn.com/ts/tikimsp/9a/e5/79/e9bc447df1f841826e840a2baf7f84e2.png" className='hover:opacity-90' alt="" />
                    </div>
                    <div className='w-1/6 mx-1'>
                      <img src="https://salt.tikicdn.com/ts/tikimsp/31/ce/ca/6381e2413483f07cb9d3aed455d06037.png" className='hover:opacity-90' alt="" />
                    </div>
                    <div className='w-1/6 mx-1'>
                      <img src="https://salt.tikicdn.com/ts/tikimsp/4b/4c/15/ac2e7298428eb6de74f3fd6250ed208b.png" className='hover:opacity-90' alt="" />
                    </div>
                    <div className='w-1/6 mx-1'>
                      <img src="https://salt.tikicdn.com/ts/tikimsp/d9/a9/2a/6f6ac8a0619061cc8251087328509f47.png" className='hover:opacity-90' alt="" />
                    </div>
                    <div className='w-1/6 mx-1'>
                      <img src="https://salt.tikicdn.com/ts/tikimsp/38/20/a2/2539d973cf9d350363b7f4fca859bd8d.png" className='hover:opacity-90' alt="" />
                    </div>
                  </div>
                </div>
                ...
                <div className='w-full px-4 py-3 my-6'>
                  <div className='flex relative'>
                    ...
                    <div className='flex absolute right-0 h-6'>
                      <a className='text-blue-700 hover:bg-blue-50' href="">Xem thêm</a>
                  ...
                  <div className='flex'>
                    <div className='w-1/6 p-2'>
                      <a className='relative' href="">
                        <img src="https://salt.tikicdn.com/cache/280x280/ts/product/08/3a/5c/f877a7d9bc05e399e96bc7c83d5fe8be.jpg" className='hover:opacity-90' alt="" />
                    ...
                    <div className='w-1/6 p-2'>
                      <a className='relative' href="">
                        <img src="https://salt.tikicdn.com/cache/280x280/ts/product/83/10/35/78f3a295a747adbe3ae2e27659f2c5c4.jpg" className='hover:opacity-90' alt="" />
                        <div className='absolute bottom-0 left-0 w-1/2 '>
                          <img src="https://salt.tikicdn.com/ts/upload/dc/0d/49/ef9dc5d8164bd62b011e54276502b342.png" alt="" />
                        </div>
                      </a>
                    ...
                    <div className='w-1/6 p-2'>
                      <div className='relative' >
                        <img src="https://salt.tikicdn.com/cache/280x280/ts/product/05/e7/48/054f98b76c1dd795778b4afc7ad6a283.jpg" className='hover:opacity-90' alt="" />
                    ...
                    <div className='w-1/6 p-2'>
                      <div className='relative' >
                        <img src="https://salt.tikicdn.com/cache/280x280/ts/product/24/0f/da/2e4a03235e51f6975524569dbbcb88ab.jpg" className='hover:opacity-90' alt="" />
                      </div>
                      <div className='text-center text-red-500 font-bold my-1'>
                        <span >
                          522.000
                    ...
                    <div className='w-1/6 p-2'>
                      <a className='relative' href="">
                        <img src="https://salt.tikicdn.com/cache/280x280/ts/product/90/49/97/ec88ab408c1997378344486c94dbac40.jpg" className='hover:opacity-90' alt="" />
                        <div className='absolute bottom-0 left-0 w-1/2 '>
                          <img src="https://salt.tikicdn.com/ts/upload/dc/0d/49/ef9dc5d8164bd62b011e54276502b342.png" alt="" />
                        </div>
                      </a>
                    ...
                    <div className='w-1/6 p-2'>
                      <a className='relative' href="">
                        <img src="https://salt.tikicdn.com/cache/280x280/ts/product/85/6b/3f/d1356390e98112020c8a897da7c00880.png" className='hover:opacity-90' alt="" />
                        <div className='absolute bottom-0 left-0 w-1/2 '>
                          <img src="https://salt.tikicdn.com/ts/upload/dc/0d/49/ef9dc5d8164bd62b011e54276502b342.png" alt="" />
                        </div>
                      </a>
                ...
                <div className='w-full px-4 py-3 my-6'>
                  ...
                  <div className='flex mt-4 bg-opacity-95'>
                    <div className='w-1/6 mx-1'>
                      <img src="https://salt.tikicdn.com/ts/tikimsp/e8/b8/a1/bdd3d61d1afa23b5f73664a859a4b53c.png" className='rounded-lg hover:opacity-90' alt="" />
                    </div>
                    <div className='w-1/6 mx-1 box-border'>
                      <div className='mb-0.5'>
                        <img src="https://salt.tikicdn.com/ts/tikimsp/74/34/38/fe1083b0c8a85f13f89ceb482893bd5c.png" className='rounded-lg hover:opacity-90' alt="" />
                      </div>
                      <div>
                        <img src="https://salt.tikicdn.com/ts/tikimsp/c3/5c/58/4a2330f2ec9089ffc1ceac5ccf408936.png" className='rounded-lg hover:opacity-90' alt="" />
                      </div>
                    </div>
                    <div className='w-1/6 mx-1'>
                      <img src="https://salt.tikicdn.com/ts/tikimsp/97/c9/e5/b8db84f10f062ea2f7e1030088dd8fa3.png" className='rounded-lg hover:opacity-90' alt="" />
                    </div>
                    <div className='w-1/6 mx-1 box-border'>
                      <div className='mb-0.5'>
                        <img src="https://salt.tikicdn.com/ts/tikimsp/de/4e/84/44159bf0bc2954a29b0be1c1820b74bd.png" className='rounded-lg hover:opacity-90' alt="" />
                      </div>
                      <div>
                        <img src="https://salt.tikicdn.com/ts/tikimsp/b0/87/f8/e230f8ea52b4d895cb3a733c37d4c156.png" className='rounded-lg hover:opacity-90' alt="" />
                      </div>
                    </div>
                    <div className='w-1/6 mx-1'>
                      <img src="https://salt.tikicdn.com/ts/tikimsp/ea/46/56/9e420c447d11e6ce354fefa0fc771d45.png" className='rounded-lg hover:opacity-90' alt="" />
                    </div>
                    <div className='w-1/6 mx-1 box-border'>
                      <div className='mb-0.5'>
                        <img src="https://salt.tikicdn.com/ts/tikimsp/5b/b8/13/177d4250d17590e6fd3943e63e3dd37e.png" className='rounded-lg hover:opacity-90' alt="" />
                      </div>
                      <div>
                        <img src="https://salt.tikicdn.com/ts/tikimsp/7f/95/d7/dde89c5adf06c58d00b49a5d6e0d7a7b.png" className='rounded-lg hover:opacity-90' alt="" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className='w-full px-4 py-3 my-6'>
                  ...
                  <div className='flex mt-4 bg-opacity-95'>
                    <div className='w-1/6 mx-1'>
                        <img src="https://salt.tikicdn.com/ts/brickv2og/e9/32/fe/4164dd29e0596f89fdc2b94efba0d110.png" className='rounded-lg hover:opacity-90' alt="" />
                    </div>
                    <div className='w-1/6 mx-1'>
                        <img src="https://salt.tikicdn.com/ts/brickv2og/de/8f/2b/854c945eba523ef7e1d2a8f7cb9280a5.png" className='rounded-lg hover:opacity-90' alt="" />
                    </div>
                    <div className='w-1/6 mx-1'>
                        <img src="https://salt.tikicdn.com/ts/brickv2og/2d/96/a8/520af0d524c1622445cdc73709ef6228.png" className='rounded-lg hover:opacity-90' alt="" />
                    </div>
                    <div className='w-1/6 mx-1'>
                        <img src="https://salt.tikicdn.com/ts/brickv2og/69/b0/7f/4f9d8a543d966fbff382cafbbd469e75.png" className='rounded-lg hover:opacity-90' alt="" />
                    </div>
                    <div className='w-1/6 mx-1'>
                        <img src="https://salt.tikicdn.com/ts/brickv2og/73/91/78/729923e734b3a8f7b3b86f3e9d54ff64.png" className='rounded-lg hover:opacity-90' alt="" />
                    </div>
                    <div className='w-1/6 mx-1'>
                        <img src="https://salt.tikicdn.com/ts/brickv2og/c9/14/b6/7afdf8bc306cc86aed001f5436f872d0.png" className='rounded-lg hover:opacity-90' alt="" />
                    </div>
                  </div>
                </div>
                ...
                {/* Suggession today */}
                  <div>
                    ...
                    <div className='flex mt-4 text-center text-xs'>
                      <div className='w-1/6 p-2 hover:bg-blue-100 border border-b-blue-500'>
                          <div className='w-full'>
                            <img src="https://salt.tikicdn.com/ts/personalish/f9/27/b5/3a8e2286a1c8fb91b67acc5ee35f82f0.png" className='h-10 mx-auto' alt="" />
                          </div>
                          <div className='opacity-70 pt-1 text-blue-500 '>Dành cho bạn</div>
                      </div>
                      <div className='w-1/6 p-2 hover:bg-gray-200'>
                          <img src="https://salt.tikicdn.com/ts/tikimsp/2d/3a/53/f4ab4353cd78836ad8acc4a464ed439b.png" className='h-10 mx-auto ' alt="" />
                          <div className='opacity-70 pt-1' >Siêu sale Freeship</div>
                      </div>
                      <div className='w-1/6 p-2 hover:bg-gray-200'>
                          <img src="https://salt.tikicdn.com/ts/tikimsp/d4/de/6f/43ac74a95828ed1f8208802738ecc618.png" className='h-10 mx-auto ' alt="" />
                          <div className='opacity-70 pt-1'>Freeship</div>
                      </div>
                      <div className='w-1/6 p-2 hover:bg-gray-200'>
                          <img src="https://salt.tikicdn.com/ts/personalish/1a/41/2f/bd05c095d72298752832dd5e87917c1c.png" className='h-10 mx-auto ' alt="" />
                          <div className='opacity-70 pt-1'>Astra Plus</div>
                      </div>
                      <div className='w-1/6 p-2 hover:bg-gray-200'>
                          <img src="https://salt.tikicdn.com/ts/personalish/b7/aa/f3/bcff08097ead36826d2c9daf7c2debd5.png" className='h-10 mx-auto ' alt="" />
                          <div className='opacity-70 pt-1'>Đi chợ siêu sale</div>
                      </div>
                      <div className='w-1/6 p-2 hover:bg-gray-200'>
                          <img src="https://salt.tikicdn.com/ts/personalish/08/b8/5c/5c6327fd3cf12c534bff4a55dab2f12d.png" className='h-10 mx-auto ' alt="" />
                          <div className='opacity-70 pt-1'>Dịch vụ số</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className='py-3'>
                    <div className='flex'>
                      <div className='w-2/6 mx-1'>
                        <img src="https://salt.tikicdn.com/ts/tka/b2/54/e8/b73b9c353aaabbcb227cd130d0e21708.png" className='hover:opacity-90 rounded-md' alt="" />
                      </div>
                      <div className='w-1/6 mx-1'>
                        <a className='relative'>
                          <img src="https://salt.tikicdn.com/cache/280x280/ts/product/a9/d7/01/d39e909e4d4bb689f436fd6d595e0deb.jpg" className='hover:opacity-90 rounded-md' alt="" />
                      ...
                      <div className='w-1/6 mx-1'>
                        <a className='relative'>
                          <img src="https://salt.tikicdn.com/cache/280x280/ts/product/7c/fe/ef/e2c2356936306900553864262d22b9e8.jpg" className='hover:opacity-90 rounded-md' alt="" />
                          <div className='absolute bottom-0 left-0'>
                            <img src="https://salt.tikicdn.com/ts/upload/d6/51/17/cde193f3d0f6da18147a739247c95c93.png" className='h-6' alt="" />
                          </div>
                        </a>
                      ...
                      <div className='w-1/6 mx-1'>
                        <a className='relative'>
                          <img src="https://salt.tikicdn.com/cache/280x280/ts/product/36/2f/39/2d905079cfeaa9cb26c729f7c908573c.jpg" className='hover:opacity-90 rounded-md' alt="" />
                          <div className='absolute bottom-0 left-0'>
                            <img src="https://salt.tikicdn.com/ts/upload/d6/51/17/cde193f3d0f6da18147a739247c95c93.png" className='h-6' alt="" />
                          </div>
                        </a>
                    ...
                    <div className='flex my-2'>
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/31/c9/c1/6b51bab31ce059e63f8162c9203f4c04.jpg" className='hover:opacity-90 rounded-md' alt="" />
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/b6/44/a4/d2d6d589d4266cc1017735c4e8269073.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute top-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/5d/4c/f7/0261315e75127c2ff73efd7a1f1ffdf2.png" className='h-4' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/2d/ef/af/ce6abb6eb0588d68b1655a11bd5de643.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute top-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/5d/4c/f7/0261315e75127c2ff73efd7a1f1ffdf2.png" className='h-4' alt="" />
                            </div>
                          </a>
                          <div className='my-2 mx-2'>
                            ...
                            <div className='my-2 h-6 items-center px-2 flex text-center'>
                              <img src="https://salt.tikicdn.com/ts/upload/9e/13/50/6d16b5e1d219857bd23572ce049e59e2.png" className='h-4 mr-1' alt="" />
                              <span className='text-xs opacity-60'>
                              Giao siêu tốc 2h
                              </span> 
                            </div>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/d1/63/65/bd9547bee3093f1daa485a1e9235bcc8.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute top-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/5d/4c/f7/0261315e75127c2ff73efd7a1f1ffdf2.png" className='h-4' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/media/catalog/product/tmp/97/55/9f/c00c43793156e16b8bee9cd3c0bd8c84.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute top-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/5d/4c/f7/0261315e75127c2ff73efd7a1f1ffdf2.png" className='h-4' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/83/0a/3d/087ab425f54d85260406afbed218269c.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute top-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/5d/4c/f7/0261315e75127c2ff73efd7a1f1ffdf2.png" className='h-4' alt="" />
                            </div>
                          </a>
                    ...
                    <div className='flex my-2'>
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/6f/37/04/d2296400d13bb5ca9a2e3e02d00a97da.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute bottom-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/d6/51/17/cde193f3d0f6da18147a739247c95c93.png" className='h-6' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/98/3c/62/b6dc54ecad3eb6d73749c91b4f350240.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute bottom-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/d6/51/17/cde193f3d0f6da18147a739247c95c93.png" className='h-6' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/3a/c2/ca/50b70579187bb5c2d29eeea585e3eb90.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute bottom-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/d6/51/17/cde193f3d0f6da18147a739247c95c93.png" className='h-6' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/b6/59/47/0d9d6caa21c0c52ffbc9bc9bfca13d52.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute bottom-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/d6/51/17/cde193f3d0f6da18147a739247c95c93.png" className='h-6' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/a4/61/14/185a09d41bff6317a3538a8bd5d8a465.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute bottom-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/d6/51/17/cde193f3d0f6da18147a739247c95c93.png" className='h-6' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/72/a8/e4/50a0a74b4543124692abe59fec32925a.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute bottom-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/d6/51/17/cde193f3d0f6da18147a739247c95c93.png" className='h-6' alt="" />
                            </div>
                          </a>
                    ...
                    <div className='flex my-2'>
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/fe/be/55/bd21cd6f6513302a9ddb2ae92233ef32.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute top-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/5d/4c/f7/0261315e75127c2ff73efd7a1f1ffdf2.png" className='h-4' alt="" />
                            </div>
                          </a>
                          <div className='my-2 mx-2'>
                            ...
                            <div className='my-2 h-6 flex items-center px-2 text-center'>
                              <img src="https://salt.tikicdn.com/ts/upload/9e/13/50/6d16b5e1d219857bd23572ce049e59e2.png" className='h-4 mr-1' alt="" />
                              <span className='text-xs opacity-60'>
                              Giao siêu tốc 2h
                              </span>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/d1/96/73/aec04561b0870a7495c81baa46f6f0ef.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute top-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/5d/4c/f7/0261315e75127c2ff73efd7a1f1ffdf2.png" className='h-4' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/8d/25/95/415ab62220428bf1e4303cc13e4e170c.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute top-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/5d/4c/f7/0261315e75127c2ff73efd7a1f1ffdf2.png" className='h-4' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/c1/fc/ae/3ba5e2ddea1f9306b3f048d0688f962a.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute top-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/5d/4c/f7/0261315e75127c2ff73efd7a1f1ffdf2.png" className='h-4' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/7b/45/cd/a4b48cf886b8c379cb52b3d0c530f094.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute top-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/5d/4c/f7/0261315e75127c2ff73efd7a1f1ffdf2.png" className='h-4' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/1b/30/6f/b88b6fd6efbf7deaa3aa6c153e734140.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute top-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/5d/4c/f7/0261315e75127c2ff73efd7a1f1ffdf2.png" className='h-4' alt="" />
                            </div>
                          </a>
                    ...
                    <div className='flex my-2'>
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/cc/fc/cd/2879405df6d64b73d0110f67125ac9cc.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute bottom-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/d6/51/17/cde193f3d0f6da18147a739247c95c93.png" className='h-6' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/39/e5/13/69f02f6ec5c3ea60edef5ed5f50513c9.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute bottom-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/d6/51/17/cde193f3d0f6da18147a739247c95c93.png" className='h-6' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/b3/20/fa/efe1fcdbf8a0d97d45003bba4c60ceb4.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute bottom-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/d6/51/17/cde193f3d0f6da18147a739247c95c93.png" className='h-6' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/c2/e5/36/ae5ed89571efe89d5130aba0f89bc3cd.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute bottom-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/d6/51/17/cde193f3d0f6da18147a739247c95c93.png" className='h-6' alt="" />
                            </div>
                          </a>
                    ...
                    <div className='flex my-2'>
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/6f/57/1c/45857aed11e26f0250a639e26d2b4ac5.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute top-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/5d/4c/f7/0261315e75127c2ff73efd7a1f1ffdf2.png" className='h-4' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/2a/87/22/62055dad6166cf55be2ce1b190ad22a0.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute top-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/5d/4c/f7/0261315e75127c2ff73efd7a1f1ffdf2.png" className='h-4' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          ...
                          <div className='my-2 mx-2'>
                            ...
                            <div className='my-2 px-2 h-6 items-center flex text-center'>
                              <img src="https://salt.tikicdn.com/ts/upload/9e/13/50/6d16b5e1d219857bd23572ce049e59e2.png" className='h-4 mr-1' alt="" />
                              <span className='text-xs opacity-60'>
                              Giao siêu tốc 2h
                              </span> 
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/32/78/51/af8bfc1f1a061e5274d76fb44599eba4.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute top-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/5d/4c/f7/0261315e75127c2ff73efd7a1f1ffdf2.png" className='h-4' alt="" />
                            </div>
                          </a>
                      ...
                      <div className='w-1/6 mx-1'>
                          <a className='relative'>
                            <img src="https://salt.tikicdn.com/cache/280x280/ts/product/f9/f2/c0/936823c66c2f1c347d192671b48b42e0.jpg" className='hover:opacity-90 rounded-md' alt="" />
                            <div className='absolute top-0 left-0'>
                              <img src="https://salt.tikicdn.com/ts/upload/5d/4c/f7/0261315e75127c2ff73efd7a1f1ffdf2.png" className='h-4' alt="" />
                            </div>
                          </a>
                    ...
                    <div className='text-center my-3 h-10 w-full'>
                      <a href="#" className='border-blue-500 border px-16 text-blue-500 rounded-md hover:bg-blue-100 py-2'>
                        Xem Thêm
                      </a> 
                    </div>          
                  </div>
